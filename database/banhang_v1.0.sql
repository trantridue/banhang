...
-- Table `banhang`.`role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `banhang`.`role` ;

CREATE TABLE IF NOT EXISTS `banhang`.`role` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `banhang`.`user_role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `banhang`.`user_role` ;

CREATE TABLE IF NOT EXISTS `banhang`.`user_role` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE INDEX `fk_user_role_role_idx` ON `banhang`.`user_role` (`role_id` ASC);

CREATE INDEX `fk_user_role_user1_idx` ON `banhang`.`user_role` (`user_id` ASC);
...
-- -----------------------------------------------------
-- Table `banhang`.`customer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `banhang`.`customer` ;

CREATE TABLE IF NOT EXISTS `banhang`.`customer` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `banhang`.`customer_reservation_histo` (
  ...
  CONSTRAINT `fk_customer_reservation_histo_customer1`
    ...
    REFERENCES `banhang`.`customer` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_customer_reservation_histo_customer1_idx` ON `banhang`.`customer_reservation_histo` (`customer_id` ASC);
...
CREATE INDEX `fk_export_facture_customer1_idx` ON `banhang`.`export_facture` (`customer_id` ASC);
...
CREATE INDEX `fk_export_facture_trace_customer1_idx` ON `banhang`.`export_facture_trace` (`customer_id` ASC);
...
-- -----------------------------------------------------
-- Table `banhang`.`configuration`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `banhang`.`configuration` ;

CREATE TABLE IF NOT EXISTS `banhang`.`configuration` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `value` VARCHAR(45) NOT NULL,
...
START TRANSACTION;
USE `banhang`;
INSERT INTO `banhang`.`user` (`id`, `shop_id`, `name`, `email`, `phone_number`, `username`, `password`, `confirmcode`, `status`, `start_date`, `end_date`, `description`, `salary_by_hour`, `work_from`, `work_to`) VALUES (1, 1, 'Trần Trí Duệ', 'trantridue@gmail.com', '0979355285', 'admin', '4eae18cf9e54a0f62b44176d074cbe2f', 'y', 'y', '2014-01-01 10:00:00', '2020-12-31 22:00:00', 'Ông chủ', 8000, 8, 21);
